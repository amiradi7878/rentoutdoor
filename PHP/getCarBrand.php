...
SELECT  car_rental.rental_Id, car_rental.rental_Title, car_rental.rental_Address, car_rental.rental_Telephone, car_rental.rental_Email, 
        ...
        car_rental.rental_Verif, car_rental.thumbImage1, car_rental.rental_Tag, car_car.car_Id, car_car.car_Title, car_car.car_BrandID, car_car.car_RentalId, 
...
AND car_car.car_BrandID='" . $_GET['value'] . "' ");
