...
SELECT car_rental.rental_Id, car_rental.rental_Title, car_rental.rental_Address, car_rental.rental_Email, car_rental.rental_Web, car_rental.rental_Fb, car_rental.rental_Twitter,
        ...
        car_rental.rental_Verif, car_rental.rental_Tag, car_car.car_Id, car_car.car_Title, car_car.car_RentalId, car_car.car_price, car_car.car_year, car_car.image1, car_car.image2, car_car.image3
FROM car_rental, car_car
WHERE car_car.car_RentalId='" . $_GET['value'] . "' AND car_rental.rental_Id='" . $_GET['value'] ."' ");
...
{
    $qu=mysqli_query($con,"
SELECT car_rental.rental_Id, car_rental.rental_Title, car_rental.rental_Address, car_rental.rental_Telephone, car_rental.rental_Email, car_rental.rental_Web, car_rental.rental_Fb, car_rental.rental_Twitter,
        car_rental.rental_Lat, car_rental.rental_Long, car_rental.rental_Rating, car_rental.ratingCount, car_rental.ratingScore, car_rental.rental_Tagline, car_rental.rental_Desc,
        car_rental.rental_Verif, car_rental.rental_Tag, car_car.car_Id, car_car.car_Title, car_car.car_RentalId, car_car.car_price, car_car.car_year, car_car.image1, car_car.image2, car_car.image3
FROM car_rental, car_car
WHERE car_car.car_RentalId=car_rental.rental_Id");
