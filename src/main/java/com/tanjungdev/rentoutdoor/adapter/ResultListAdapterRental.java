...
public class ResultListAdapterRental extends ArrayAdapter<Category> implements View.OnClickListener {
    private final LayoutInflater inflater;
    private final ArrayList<Item> searchResultList;
    private Activity activity;
    private ResultListFragment.ResultListCallbacks mCallbacks;

    public ResultListAdapterRental(Activity activity, ResultListFragment.ResultListCallbacks mCallbacks, ArrayList<Item> searchResultList) {
        super(activity, R.layout.layout_result_list_rental);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        row.txtPrice.setText("Rp."+item.getCarPrice());
        if (item.isVerified()) {
